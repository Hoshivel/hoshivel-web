  ...
  },
  {
    ...
    text: {
      "zh-Hant": {
        title: "後端合夥人",
        area: "Hoshi ID 與遊戲服務",
        desc: "用 Go 打造帳號、分流與遊戲伺服器等長期運行的服務——小而可靠，不堆多餘相依。要撐十年的東西，架構得一起想清楚。",
        skills: "Go · 分散式基礎 · 重視簡潔與可維運性",
      },
      "zh-CN": {
        title: "后端合伙人",
        area: "Hoshi ID 与游戏服务",
        desc: "用 Go 打造账号、分流与游戏服务器等长期运行的服务——小而可靠，不堆多余依赖。要撑十年的东西，架构得一起想清楚。",
        skills: "Go · 分布式基础 · 重视简洁与可运维性",
      },
      en: {
        title: "Back-end Partner",
        area: "Hoshi ID & game services",
        desc: "Build long-running services in Go — accounts, routing, game servers. Small, reliable, no excess dependencies. Anything meant to last a decade is architecture we think through together.",
