...
export const ROLES: RoleEntry[] = [
  {
    ...
    text: {
      ...
      ja: {
        ...
        desc: "キャラクターの立ち絵、宣伝素材、シーンのコンセプト、ビジュアルの方向性の整理に関わっていただきます。デジタル作画でも AI を併用したワークフローでも構いません。私たちが見ているのは、はっきりしたアートの判断、仕上げと修正の力、そして世界全体を一つの世界に見せる意識です。",
  ...
  },
  {
    ...
    text: {
      ...
      ja: {
        ...
        desc: "作品の対外コンテンツの企画と制作に関わっていただきます。コミュニティ投稿、宣伝文、短尺動画と素材の整理、公開のペース配分、そしてプレイヤーとの日々のやり取りまで。露出を積み上げることや流行を追うことが目的ではなく、作品を本当に理解し、それをどうプレイヤーに紹介するかを知っている人を探しています。",
        skills:
  ...
  },
  {
    ...
    text: {
      ...
      ja: {
        ...
        desc: "コアバックエンドと基盤サービスは、いまのところ通常のパートタイムでは広げていません。すでに私たちと実際のプロジェクトを一緒に仕上げたことがあり、作品の方向にも長く関わりたいという方は、コアチームへの参加についてぜひお話しさせてください。",
